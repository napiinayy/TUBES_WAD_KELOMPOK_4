    ...
    <div class="main-container">
        ...
        <main class="main-content">
            <div class="content-wrapper">
                ...
                <!-- Form Card -->
                <div class="form-card">
                    <form method="POST" action="/test-admin/users/{{ $user->id }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('id_lab') is-invalid @enderror" 
                                        ...
                                        @foreach($labs ?? [] as $lab)
                                            <option value="{{ $lab->id }}" {{ old('id_lab', $user->id_lab) == $lab->id ? 'selected' : '' }}>
                                                {{ $lab->nama_lab }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-footer">
                            <a href="/test-admin/users" class="btn btn-secondary">Batal</a>
